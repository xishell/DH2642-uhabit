		...
		<div class="flex flex-col gap-4">
			<div class="flex flex-col gap-1">
				...
				{#if fieldErrors.title}
					<p id="goal-title-error" class="text-red-500 text-xs mt-1" role="alert">
						{fieldErrors.title}
					</p>
				{/if}
			</div>
			...
			<div class="flex flex-col gap-1">
				...
				{#if fieldErrors.description}
					<p id="goal-description-error" class="text-red-500 text-xs mt-1" role="alert">
			...
			<div class="grid grid-cols-2 gap-4">
				<div class="flex flex-col gap-1">
					...
					{#if fieldErrors.startDate}
						<p id="goal-start-error" class="text-red-500 text-xs mt-1" role="alert">
				...
				<div class="flex flex-col gap-1">
					...
					<input
						...
						class:border-red-500={fieldErrors.endDate}
						bind:value={endDate}
						min={startDate}
					...
					{#if fieldErrors.endDate}
						<p id="goal-end-error" class="text-red-500 text-xs mt-1" role="alert">
							{fieldErrors.endDate}
						</p>
					{/if}
				</div>
