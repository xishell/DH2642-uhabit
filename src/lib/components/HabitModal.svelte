...
<Modal {open} title={modalTitle} {onclose}>
	<form onsubmit={handleSubmit} class="flex flex-col gap-6">
		{#if error}
			<p class="text-red-600 text-sm text-center" role="alert">{error}</p>
		{/if}
			...
			<div class="flex flex-col gap-4">
				<div class="flex flex-col gap-1">
					...
					{#if fieldErrors.title}
						<p id="habit-title-error" class="text-red-500 text-xs mt-1" role="alert">
							{fieldErrors.title}
						</p>
					{/if}
				</div>
				...
				<div class="flex flex-col gap-1">
					...
					{#if fieldErrors.notes}
						<p id="habit-notes-error" class="text-red-500 text-xs mt-1" role="alert">
							{fieldErrors.notes}
						</p>
					{/if}
				</div>
				...
				<div class="flex flex-col gap-1">
					...
					<div class="flex gap-3 mt-1">
						<input
							...
							class:border-red-500={fieldErrors.targetAmount}
							placeholder="100"
					...
					{#if fieldErrors.targetAmount}
						<p id="habit-target-error" class="text-red-500 text-xs mt-1" role="alert">
							{fieldErrors.targetAmount}
						</p>
					{/if}
					{#if fieldErrors.unit}
						<p id="habit-unit-error" class="text-red-500 text-xs mt-1" role="alert">
							{fieldErrors.unit}
						</p>
					{/if}
				</div>
